...
export const meetingSchema = z.object({
  ...
  initialPrayer: z.string().uuid().or(z.literal("")).transform((val) => (val === "" ? null : val)).optional().nullable(),
  finalPrayer: z.string().uuid().or(z.literal("")).transform((val) => (val === "" ? null : val)).optional().nullable(),
  responsibleForReflection: z.string().uuid().or(z.literal("")).transform((val) => (val === "" ? null : val)).optional().nullable(),
